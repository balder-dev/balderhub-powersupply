# BalderHub Package ``balderhub-powersupply``
...
```
python -m pip install balderhub-powersupply
```

# Check out the documentation

If you need more information, 
[checkout the ``balderhub-powersupply`` documentation](https://hub.balder.dev/projects/powersupply).
